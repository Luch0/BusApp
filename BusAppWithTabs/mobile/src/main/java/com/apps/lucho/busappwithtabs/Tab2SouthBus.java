...
public class Tab2SouthBus extends Fragment {

    private static final String TAG = Tab2SouthBus.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_south_bus, container, false);
        return rootView;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) getActivity().findViewById(R.id.busRecyclerViewSouth);
        ...
        Log.d(TAG, "TAB 2: " + busEnteredStr);

        AsyncHttpClient client = new AsyncHttpClient();
        client.get("http://bustime.mta.info/api/stops-on-route-for-direction?&routeId=MTA+NYCT_" + busEnteredStr + "&directionId=1", new AsyncHttpResponseHandler() {
            @Override
            public void onStart() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] response) {
                ...
                RTclient.get("http://api.prod.obanyc.com/api/siri/vehicle-monitoring.json?key=" + API_KEY + "&LineRef=MTA%20NYCT_" + busEnteredStr + "&DirectionRef=1&VehicleMonitoringDetailLevel=minimum", new AsyncHttpResponseHandler() {
                    @Override
                    public void onStart() {
                        // called before request is started
                    }
    ...
    public void populateBuses(String jsoBusesStr, int numBuses){
        try {
            ...
            tl.getTabAt(1).setText("TO " + busList.get(0).getDestinationName());
